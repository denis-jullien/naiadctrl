...
class CS1237:
    def __init__(self, sck_pin, data_read_pin, data_write_pin, 
                 pga=CS1237_PGA_1, speed=CS1237_SPEED_10HZ, 
                 channel=CS1237_CHANNEL_A, refo=CS1237_REFO_DISABLE,
        ...
        GPIO.setup(self.data_write_pin, GPIO.OUT, initial=GPIO.LOW)  # Keep low for reading
        
        print(f"CS1237 initialized with pins: SCK={sck_pin}, DATA_READ={data_read_pin}, DATA_WRITE={data_write_pin}")
    ...
    async def initialize(self):
        ...
        config_byte = (self.speed & 0x03) | ((self.pga & 0x03) << 2) | \
                      ((self.channel & 0x01) << 4) | ((self.refo & 0x01) << 5)
        ...
        print(f"CS1237 configured: PGA={self.pga}, SPEED={self.speed}, CHANNEL={self.channel}, REFO={self.refo}")
    ...
    def _ref(self):
        ...
        rate_values = {CS1237_SPEED_10HZ: 0.1, CS1237_SPEED_40HZ: 0.025, CS1237_SPEED_640HZ: 0.0015625, CS1237_SPEED_1280HZ: 0.00078125}
