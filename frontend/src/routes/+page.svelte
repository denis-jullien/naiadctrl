<script>
  ...
  import { sensor, controller, history, fetchSensorData, fetchControllerData, fetchSensorHistory } from '$lib/state.svelte';
...
<div class="space-y-8">
  ...
  <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
    ...
    <Card>
      ...
      <CardContent>
        <div class="text-2xl font-bold">{sensor.water_temperature ? sensor.water_temperature.toFixed(1) : 'N/A'} °C</div>
        <p class="text-xs text-muted-foreground">
          Air: {sensor.air_temperature ? sensor.air_temperature.toFixed(1) : 'N/A'} °C
          Humidity: {sensor.humidity ? sensor.humidity.toFixed(1) : 'N/A'} %
        </p>
      </CardContent>
    </Card>
  </div>
  ...
  <div class="grid gap-4 md:grid-cols-2">
    ...
    <Card>
      ...
      <CardContent>
        ...
        <UplotSvelte data={[history.timestamps, history.air_temperature]} {options}/>
