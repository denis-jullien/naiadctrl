...
declare module '$env/static/private' {
	...
	export const CANalyzer_InstallDir: string;
	export const CANalyzer_InstallDir64: string;
	export const CAN_BITRATE: string;
	export const CAN_CHANNEL: string;
	export const CAN_INTERFACE: string;
	export const CDLMD_LICENSE_FILE: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		CANalyzer_InstallDir: string;
		CANalyzer_InstallDir64: string;
		CAN_BITRATE: string;
		CAN_CHANNEL: string;
